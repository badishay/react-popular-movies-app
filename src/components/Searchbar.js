...
function Searchbar() {
    ...
    return (
        ...
        <div className='  bg-white h-10 rounded-l-full border-2 border-r-0 border-gray-500'>
            ...
            <input type="text" value={inputFiled} className='bg-transperent w-full bg-transparent ml-6 pl-4 pt-1 mr-2  text-lg font-semibold   focus:outline-none focus:placeholder-gray-300 placeholder-gray-400  ' placeholder='search for movies' 
            onChange={e=>{
