...
const MovieItem = (props) => {
    ...
    return (
      ...
      context=>(
        <div>
        {props.item.poster_path?(<div className=' my-6 mx-3 w-52 h-80   transition duration-500  transform hover:-translate-y-1 hover:scale-110 cursor-pointer  bg-gray-600 ease-in-out   rounded-lg  p-1/2 shadow-md content-center' 
